...
/*
	...
	ANN::BPLayer layer7(6, ANN::ANLayerOutput);

	layer1.ConnectLayer(&layer2);
	layer2.ConnectLayer(&layer3);
	layer3.ConnectLayer(&layer4);
	layer4.ConnectLayer(&layer7);

//	ANBPLayer::SetEdges2Value(&layer1, &layer2, 1.0);
//	ANBPLayer::SetEdges2Value(&layer2, &layer7, 1.0);
...
/*
	...
	ANN::TrainingSet input12;
	input12.AddInput(TR, 16);
	input12.AddInput(TR2, 16);
	input12.AddInput(TR3, 16);

	ANN::HFNet hfnet;
	hfnet.Resize(16,1);
	hfnet.SetTrainingSet(input12);
	hfnet.PropagateBW();
